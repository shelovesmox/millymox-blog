...
!(function () {
  ...
  !(function (e) {
      ...
      (e.SimpleJekyllSearch = function (e) {
          return (
              f.validate(e).length > 0 && o("You must specify the following required options: " + l),
              (a = s.merge(a, e)),
              c.setOptions({ template: a.searchResultTemplate, middleware: a.templateMiddleware }),
          ...
          "function" == typeof e.SimpleJekyllSearchInit && e.SimpleJekyllSearchInit.call(this, e.SimpleJekyllSearch);
  })(window);
})();
